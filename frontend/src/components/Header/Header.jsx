  ...
  return (
    <header className="fixed bg-secondaryColor md:bg-transparent top-0 left-0 w-full z-50 px-8 py-5 md:p-8 flex items-center justify-between">
      ...
      <div className="hidden md:flex flex-1 justify-center">
        <button onClick={navigate('/order-online')} className="bg-primaryColor text-tertiaryColor py-3 px-4 rounded-full font-semibold hover:scale-105 transition-transform hover:bg-orange-400">
          Order Online
        </button>
      </div>
