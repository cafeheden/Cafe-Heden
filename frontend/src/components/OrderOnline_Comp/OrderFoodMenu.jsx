...
import MenuItem from "../OrderOnline_Comp/OrderFoodMenuItem"; // Adjust the path as necessary
import Header from "../OrderOnline_Comp/Header"; // Adjust the path as necessary
...
const MenuPage = () => {
  ...
  return (
    <div className="home-foodMenu min-h-[600px] px-8 md:px-40">
      <div className="">
        <div className="menu-header text-center my-8 text-3xl font-semibold text-tertiaryColor">
          Our Menu
        </div>
